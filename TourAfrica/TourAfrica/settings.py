"""
Django settings for TourAfrica project.
...
WSGI_APPLICATION = 'TourAfrica.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES':[
        'TourAfricaUser.API.authentication.CustomJWTAuthentication'
    ]
}
